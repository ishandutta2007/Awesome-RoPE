...
| [**Mechanism**](variants/standard_rope_mechanism.md) | Divides high-dimensional token vectors into 2D chunks and multiplies each chunk by a 2D rotation matrix. | 2021 | [arXiv:2104.09864](https://arxiv.org/abs/2104.09864) |
...
| :--- | :--- | :--- | :--- |
| [**NTK-aware RoPE**](variants/ntk_aware_rope.md) | Down-scales frequencies of early dimensions while leaving high-frequency dimensions alone to compress long sequences without retraining. | 2023 | [Reddit Proposal](https://www.reddit.com/r/LocalLLaMA/comments/14lz77b/ntkaware_scaled_rope_allows_llama_models_to_have/) |
